...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
	...
	private BooleanExpression searchByLike(String searchdBy, String searchQuery) {
		
		if (StringUtils.equals("itemNm", searchdBy)) {
			
			return QItem.item.itemNm.like("%" + searchQuery + "%");		// itemNm Like %청바지%
		} else if (StringUtils.equals("createdBy", searchdBy)) {
			
			return QItem.item.createdBy.like("%" + searchQuery + "%");	// itemNm Like %test.com%
		}
